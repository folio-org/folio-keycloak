...
/opt/keycloak/bin/kc.sh start \
  ...
  --https-trust-store-type="${KC_HTTPS_TRUST_STORE_TYPE:-BCFKS}" \
  --https-trust-store-file="${KC_HTTPS_TRUST_STORE:-/opt/keycloak/conf/test.server.truststore}" \
  --https-trust-store-password="${KC_HTTPS_TRUST_STORE_PASSWORD:-SecretPassword}" \
